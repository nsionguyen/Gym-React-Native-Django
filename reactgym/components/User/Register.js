            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                ...
                <View style={styles.formContainer}>
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        <TextInput style={styles.input} placeholder="Nhập tên" value={firstName} onChangeText={setFirstName} />
                    </View>
                    ...
                    {avatar?.uri && <Image source={{ uri: avatar.uri }} style={{ width: 100, height: 100 }} />}
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        <View style={styles.passwordContainer}>
                            <TextInput
                                ...
                                secureTextEntry={!showPassword}
                            />
                            <TouchableOpacity style={styles.eyeIcon} onPress={() => setPasswordAgain(!showPassword)}>
                                <Ionicons name={showPassword ? "eye-off-outline" : "eye-outline"} size={24} color="gray" />
                            </TouchableOpacity>
                        </View>
                    </View>
